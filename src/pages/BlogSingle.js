...
const BogSingle = (props) => {
    console.log(useLocation())
    const [course, setCourse] = useState(null)
    const {state: {id}} = useLocation()
    useEffect(() => {
        const fetchCourse = async () => {
            const resp = await fetch(`http://localhost:3002/blogs/${id}`);
            const respJson = await resp.json()
            console.log(respJson)
            setCourse(respJson.blog)
        }
        if(id){
            fetchCourse()
        }
                                ...
                                <div class="tab-content tabs-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade sc-team team-style-style-1" id="prod-instructor" role="tabpanel" aria-labelledby="course-instructor-tab">
                                        <div class="content pt-30 pb-30 pl-30 pr-30 white-bg">
                                            <h3 class="instructor-title">Author</h3>
                                            <div class="row sc-team team-style-1 clearfix">
                                            <div class="col-lg-6 col-md-6 col-sm-12 sm-mb-30">
                                                    <div class="team-wrap">
                                                        <div class="team-img">
                                                            <a ><img src={course?.user?.image ? `http://localhost:3002/${course?.user?.image}`: "assets/images/team/1.jpg"} alt=""/></a> 
                                                        ...
                                                        <div class="team-item-text">
                                                            <div class="team-details">
                                                                <h3 class="team-name"><a >{course && course?.user?.full_name}</a></h3>
