$(document).ready(function () {
	...
	var arrow_span = '<span className="sc-menu-parent">' + arrow_down + '</span>';
	var close_button = '<div className="sub-menu-close"><i class="fa fa-times" aria-hidden="true"></i>Close</div>';
